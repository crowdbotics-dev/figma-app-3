"""
Django settings for figma_app_3 project.
...
WSGI_APPLICATION = 'figma_app_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "figma_app_3 API",
    "DESCRIPTION": "API documentation for figma_app_3 App",
    "VERSION": "v1",
}
